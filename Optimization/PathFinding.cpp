...
double PathFindingProblem::distanceToExit() {
	if (isExit())
		return 0;
	return (double)sqrt(pow(pos_x - exit_x, 2) + pow(pos_y - exit_y, 2));
}
...
double PathFindingProgrammingProblem::objective(std::vector<int> machine_code) {
